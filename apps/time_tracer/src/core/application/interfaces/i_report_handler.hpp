// core/application/interfaces/i_report_handler.hpp
#ifndef CORE_APPLICATION_INTERFACES_I_REPORT_HANDLER_HPP_
#define CORE_APPLICATION_INTERFACES_I_REPORT_HANDLER_HPP_
...
#endif // CORE_APPLICATION_INTERFACES_I_REPORT_HANDLER_HPP_