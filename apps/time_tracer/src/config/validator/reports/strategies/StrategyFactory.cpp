// config/validator/reports/strategies/StrategyFactory.cpp
#include "StrategyFactory.hpp"

// [修改] 包含所有具体的策略类头文件，并更新路径
#include "config/validator/reports/strategies/daily/DailyMd.hpp"
#include "config/validator/reports/strategies/daily/DailyTex.hpp"
#include "config/validator/reports/strategies/daily/DailyTyp.hpp"
