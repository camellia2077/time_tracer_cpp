// application/ports/i_file_system.hpp
// 文件系统接口 - 技术端口（支撑接口�?
#ifndef APPLICATION_PORTS_I_FILE_SYSTEM_HPP_
#define APPLICATION_PORTS_I_FILE_SYSTEM_HPP_
...
#endif // APPLICATION_PORTS_I_FILE_SYSTEM_HPP_
