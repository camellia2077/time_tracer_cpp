// converter/config/converter_config.cpp
...
const std::unordered_map<std::string, std::vector<DurationMappingRule>>& ConverterConfig::getDurationMappings() const { return duration_mappings_; }
...
void ConverterConfig::setDurationMappings(const std::unordered_map<std::string, std::vector<DurationMappingRule>>& mappings) { duration_mappings_ = mappings; }
