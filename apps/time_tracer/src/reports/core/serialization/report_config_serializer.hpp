// reports/core/serialization/report_config_serializer.hpp
#ifndef REPORTS_CORE_SERIALIZATION_REPORT_CONFIG_SERIALIZER_HPP_
#define REPORTS_CORE_SERIALIZATION_REPORT_CONFIG_SERIALIZER_HPP_
