// reports/core/formatters/typst/typ_utils.hpp
#ifndef REPORTS_CORE_FORMATTERS_TYPST_TYP_UTILS_HPP_
#define REPORTS_CORE_FORMATTERS_TYPST_TYP_UTILS_HPP_
...
#endif // REPORTS_CORE_FORMATTERS_TYPST_TYP_UTILS_HPP_