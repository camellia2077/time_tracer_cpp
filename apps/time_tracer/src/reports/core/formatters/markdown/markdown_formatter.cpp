// reports/core/formatters/markdown/markdown_formatter.cpp
#include "reports/core/formatters/markdown/markdown_formatter.hpp"
#include "reports/core/formatters/base/project_tree_formatter.hpp"
#include <memory>
#include <sstream>
#include <iomanip>
...
std::string format_project_tree(const reporting::ProjectTree& tree, long long total_duration, int avg_days) {
