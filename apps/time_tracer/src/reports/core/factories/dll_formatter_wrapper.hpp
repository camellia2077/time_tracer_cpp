// reports/core/factories/dll_formatter_wrapper.hpp
#ifndef REPORTS_CORE_FACTORIES_DLL_FORMATTER_WRAPPER_HPP_
#define REPORTS_CORE_FACTORIES_DLL_FORMATTER_WRAPPER_HPP_
...
#endif // REPORTS_CORE_FACTORIES_DLL_FORMATTER_WRAPPER_HPP_