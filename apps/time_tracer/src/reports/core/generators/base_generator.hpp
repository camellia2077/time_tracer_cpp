// reports/core/generators/base_generator.hpp
#ifndef REPORTS_CORE_GENERATORS_BASE_GENERATOR_HPP_
#define REPORTS_CORE_GENERATORS_BASE_GENERATOR_HPP_
...
#endif // REPORTS_CORE_GENERATORS_BASE_GENERATOR_HPP_