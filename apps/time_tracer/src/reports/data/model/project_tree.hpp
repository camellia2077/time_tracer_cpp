// reports/data/model/project_tree.hpp
#ifndef REPORTS_DATA_MODEL_PROJECT_TREE_HPP_
#define REPORTS_DATA_MODEL_PROJECT_TREE_HPP_
...
#endif // REPORTS_DATA_MODEL_PROJECT_TREE_HPP_