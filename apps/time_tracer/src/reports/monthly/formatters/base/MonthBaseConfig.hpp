...
#include "reports/shared/shared_api.hpp" //1. 包含API宏
#include <string>
#include <nlohmann/json.hpp>
#include "reports/shared/utils/config/ConfigUtils.hpp"

DISABLE_C4251_WARNING //2. 禁用C4251警告 (因为有 std::string)

class REPORTS_SHARED_API MonthBaseConfig { // 3. 添加API宏
public:
...
ENABLE_C4251_WARNING // 4. 恢复C4251警告
