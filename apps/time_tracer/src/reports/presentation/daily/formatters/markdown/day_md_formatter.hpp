// reports/presentation/daily/formatters/markdown/day_md_formatter.hpp
#ifndef REPORTS_PRESENTATION_DAILY_FORMATTERS_MARKDOWN_DAY_MD_FORMATTER_HPP_
#define REPORTS_PRESENTATION_DAILY_FORMATTERS_MARKDOWN_DAY_MD_FORMATTER_HPP_

#include "reports/domain/model/daily_report_data.hpp"
#include "reports/presentation/daily/common/day_base_config.hpp" // 直接包含基类配置
...
#endif // REPORTS_PRESENTATION_DAILY_FORMATTERS_MARKDOWN_DAY_MD_FORMATTER_HPP_
