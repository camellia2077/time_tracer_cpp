// reports/presentation/daily/formatters/statistics/latex_strategy.hpp
#ifndef REPORTS_PRESENTATION_DAILY_FORMATTERS_STATISTICS_LATEX_STRATEGY_HPP_
#define REPORTS_PRESENTATION_DAILY_FORMATTERS_STATISTICS_LATEX_STRATEGY_HPP_
 ...
 */
template <typename TConfig> class LatexStrategy : public IStatStrategy {
public:
