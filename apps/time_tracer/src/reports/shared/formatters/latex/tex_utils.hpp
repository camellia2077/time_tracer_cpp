 ...
 */
REPORTS_SHARED_API void render_title(std::stringstream &ss,
 ...
 */
REPORTS_SHARED_API void
render_summary_list(std::stringstream &ss,
 ...
 */
REPORTS_SHARED_API std::string
format_project_tree(const reporting::ProjectTree &tree,
