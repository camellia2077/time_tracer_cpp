// reports/shared/formatters/templates/base_typ_formatter.hpp
#ifndef REPORTS_SHARED_FORMATTERS_TEMPLATES_BASE_TYP_FORMATTER_HPP_
#define REPORTS_SHARED_FORMATTERS_TEMPLATES_BASE_TYP_FORMATTER_HPP_
...
protected:
  ...
  virtual void format_project_tree_section(std::stringstream &ss,
    ...
    ss << TypUtils::format_project_tree(
        data.project_tree_, data.total_duration_, get_avg_days(data),
        config_->GetCategoryTitleFont(), config_->GetCategoryTitleFontSize());
  }
};

#endif // REPORTS_SHARED_FORMATTERS_TEMPLATES_BASE_TYP_FORMATTER_HPP_
