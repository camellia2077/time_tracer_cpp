// reports/domain/model/project_tree.hpp
#ifndef REPORTS_DOMAIN_MODEL_PROJECT_TREE_HPP_
#define REPORTS_DOMAIN_MODEL_PROJECT_TREE_HPP_
...
#endif // REPORTS_DOMAIN_MODEL_PROJECT_TREE_HPP_
