// generator/components/event_generator.cpp
...
static constexpr std::array<std::string_view, 60> kDigits = {
...
void EventGenerator::GenerateEventsForDay(std::string& log_content, bool is_nosleep_day) {
