// queries/report_generators/monthly/MonthlyReportGenerator.cpp
#include "MonthlyReportGenerator.h"

#include "MonthlyReportQuerier.h"
#include "queries/_shared/MonthlyReportData.h"

#include "queries/formatters/MonthlyFormatterFactory.h" //  引入格式化器工厂，替代具体的格式化器
