...
// --- DailyReportMarkdownFormatter Class Implementation ---

std::string DailyReportMarkdownFormatter::format_report(const DailyReportData& data, sqlite3* db) const {
    std::stringstream ss;
...
void DailyReportMarkdownFormatter::_display_header(std::stringstream& ss, const DailyReportData& data) const {
...
void DailyReportMarkdownFormatter::_display_project_breakdown(std::stringstream& ss, const DailyReportData& data, sqlite3* db) const {
