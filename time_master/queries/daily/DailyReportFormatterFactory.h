// queries/report_generators/daily/formatter/DailyReportFormatterFactory.h
...
public:
     ...
     * @return 一个指向 IDailyReportFormatter 接口的智能指针。
     * @throws std::invalid_argument 如果请求了不支持的格式。
     */
    static std::unique_ptr<IDailyReportFormatter> create_formatter(ReportFormat format);
};
