...
const std::string& IntervalProcessorConfig::getRemarkPrefix() const { return remark_prefix_; }
const std::vector<std::string>& IntervalProcessorConfig::getHeaderOrder() const { return header_order_; }
const std::unordered_map<std::string, std::string>& IntervalProcessorConfig::getTextMapping() const { return text_mapping_; }
const std::unordered_map<std::string, std::string>& IntervalProcessorConfig::getTextDurationMapping() const { return text_duration_mapping_; }
const std::unordered_map<std::string, std::vector<DurationRule>>& IntervalProcessorConfig::getDurationMappings() const { return duration_mappings_; }