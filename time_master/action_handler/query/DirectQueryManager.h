// file: action_handler/query/DirectQueryManager.h

#ifndef DIRECT_QUERY_MANAGER_H
#define DIRECT_QUERY_MANAGER_H

#include <sqlite3.h>
#include <string>
#include <memory> // 用于 std::unique_ptr
#include "queries/shared/ReportFormat.h" // 引入 ReportFormat
